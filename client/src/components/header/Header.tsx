                                ...
                                <li className="dropdown_item">
                                    <Link to="/multiplayer" className="noscale">
                                        ...
                                        <svg className="cnvsvg" viewBox="0 0 1027 514" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M611.714 302.714C611.714 339.006 582.297 368.429 546 368.429C509.703 368.429 480.286 339.011 480.286 302.714C480.286 266.417 509.708 237 546 237C582.297 237 611.714 266.423 611.714 302.714Z" fill="#2563eb"/>
                                            </g>
                                            ...
                                            <path d="M963.714 302.714C963.714 339.006 934.297 368.429 898 368.429C861.703 368.429 832.286 339.011 832.286 302.714C832.286 266.417 861.708 237 898 237C934.297 237 963.714 266.423 963.714 302.714Z" fill="#2563eb"/>
                                            <defs>
