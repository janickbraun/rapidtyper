                                    ...
                                    <Link to="/play/single">
                                        <div className="nv-groupsvg">
                                            <svg className="cnvsvg" viewBox="0 0 865 448" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M721 288C676.82 288 641 323.82 641 368C641 412.18 676.82 448 721 448C765.18 448 801 412.18 801 368C801 323.8 765.2 288 721 288ZM369 288C324.82 288 289 323.8 289 368C289 412.2 324.82 448 369 448C413.18 448 449 412.2 449 368C449 323.8 413.2 288 369 288ZM341.9 160H449V64H380.4L341.9 160ZM586.3 64H497V160H662.1L586.3 64Z" fill="#036666"/>
                                                <rect x="75" y="43" width="150" height="30" rx="15" fill="#036666"/>
                                                <path d="M49 391C49 382.716 55.7157 376 64 376H184C192.284 376 199 382.716 199 391V391C199 399.284 192.284 406 184 406H64C55.7157 406 49 399.284 49 391V391Z" fill="#fff"/>
                                                <rect y="154" width="150" height="30" rx="15" fill="#fff"/>
                                                <rect y="265" width="150" height="30" rx="15" fill="#036666"/>
                                            </svg>
                                        </div>
                                ...
                                <li className="dropdown_item">
                                    <Link to="/play/lobby">
                                        ...
                                        <svg className="cnvsvg" viewBox="0 0 1027 514" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M572.029 393.072H519.971C470.844 393.072 431 432.911 431 482.043C431 491.869 438.968 499.842 448.794 499.842H643.216C653.042 499.857 661 491.9 661 482.043C661 432.911 621.161 393.072 572.029 393.072Z" fill="#fff"/>
                                            <path d="M611.714 302.714C611.714 339.006 582.297 368.429 546 368.429C509.703 368.429 480.286 339.011 480.286 302.714C480.286 266.417 509.708 237 546 237C582.297 237 611.714 266.423 611.714 302.714Z" fill="#036666"/>
                                            </g>
                                            <path d="M924.029 393.072H871.971C822.844 393.072 783 432.911 783 482.043C783 491.869 790.968 499.842 800.794 499.842H995.216C1005.04 499.857 1013 491.9 1013 482.043C1013 432.911 973.161 393.072 924.029 393.072Z" fill="#fff"/>
                                            <path d="M963.714 302.714C963.714 339.006 934.297 368.429 898 368.429C861.703 368.429 832.286 339.011 832.286 302.714C832.286 266.417 861.708 237 898 237C934.297 237 963.714 266.423 963.714 302.714Z" fill="#036666"/>
                                            <defs>
